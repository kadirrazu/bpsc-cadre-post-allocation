            ...
            <div class="col-md-12">
                    ...
                    @foreach( $cadres as $cadre )
                        ...
                        @php 
                            ...
                            $cadreAbbreviation = $cadre->cadre_abbr;

                            $serial = 1;

                            $matchedCandidates = $candidates->filter(function($candidate) use ($cadreAbbreviation){
                                return str_contains( $candidate->technical_passed_cadres, $cadreAbbreviation );
                            });

                        @endphp

                        <h3 class="mt-3 mb-3 text-info">
                            CADRE ABBR: <?php echo $cadreAbbreviation; ?>
                        </h3>
