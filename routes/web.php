...
{
    return DB::table('cadres')->where('cadre_code', $cadre_code)->first()->cadre_abbr;
}

function get_cadre_name($cadre_code)
{
    return DB::table('cadres')->where('cadre_code', $cadre_code)->first()->cadre_name;
}

function get_cadre_type($cadre_code)
{
    return DB::table('cadres')->where('cadre_code', $cadre_code)->first()->cadre_type;
}
