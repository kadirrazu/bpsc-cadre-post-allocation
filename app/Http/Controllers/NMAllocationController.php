...
class NMAllocationController extends Controller
{
    ...
    public function runNMAllocation()
    {
    ...
    private function generateAllocationQueues()
    {
        ...
        $candidates = Candidate::whereNull('assigned_cadre')->orderBy('general_merit_position', 'ASC')->get();
    ...
    private function allocateCadre( $sortedQueues )
    {
        ...
        foreach( $sortedQueues as $cadreCode => $queue )
        {
            ...
            foreach( $queue as $entry )
            {
                ...
                {
                    // Cannot allocate any seat here for this candidate (all seat exhausted)
                    continue;
                }
    ...
    } //End of function 'solveMultipleAllocations()'
...
} //End of class 'ShiftingAllocationController'
